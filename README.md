...
這個對照表全面紀錄了我的刷題軌跡。透過 **Python 快速驗證邏輯** 與 **C++ 深度優化效能** 的雙引擎策略，逐步建立完整的電腦科學核心能力。

### 📂 01. 基礎語法練習 (Basic Syntax)
*對應 Notion：【語法】系列（I/O 處理、條件判斷 `if-else`、重複迴圈 `for/while`、自訂函式）*

| 題號 / 題目名稱 | 核心觀念 | 雙引擎程式碼連結 | 解題反思 / 關鍵點 |
| :--- | :--- | :--- | :--- |
...
| 題號 / 題目名稱 | 核心觀念 | 雙引擎程式碼連結 | 解題反思 / 關鍵點 |
| :--- | :--- | :--- | :--- |
| 範例題目 | 資料｜動態陣列 (vector) | [C++](./02_Data_Structures/) / [Python](./02_Data_Structures/) | 尚未開始挑戰 |
...
| 題號 / 題目名稱 | 核心觀念 | 雙引擎程式碼連結 | 解題反思 / 關鍵點 |
| :--- | :--- | :--- | :--- |
| 範例題目 | 算法｜二分搜尋 | [C++](./03_Basic_Algorithms/) / [Python](./03_Basic_Algorithms/) | 尚未開始挑戰 |
...
| 題號 / 題目名稱 | 核心觀念 | 雙引擎程式碼連結 | 解題反思 / 關鍵點 |
| :--- | :--- | :--- | :--- |
| 範例題目 | 高階｜遞迴 (Recursion) | [C++](./04_Advanced_Topics/) / [Python](./04_Advanced_Topics/) | 尚未開始挑戰 |

<br>

### 📂 05. 位元與數論專區 (Math & Theory)
*對應 Notion：【語法｜位元運算 (Bitwise)】與【算法｜數學與數論】進階主題*

| 題號 / 題目名稱 | 核心觀念 | 雙引擎程式碼連結 | 解題反思 / 關鍵點 |
| :--- | :--- | :--- | :--- |
| 範例題目 | 語法｜位元運算 (Bitwise) | [C++](./05_Math_and_Theory/) / [Python](./05_Math_and_Theory/) | 尚未開始挑戰 |

---

💡 *作戰紀律：每完成一題，我會分批 Commit 兩種語言的實作檔案（`.cpp`, `.py`），並同步更新此對照表與 Notion 任務中心，確保知識完全內化。*
